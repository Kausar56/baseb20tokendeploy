        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-950 p-6 md:p-8 shadow-xl space-y-8">
          ...
          <div className="space-y-4 pt-4 border-t border-slate-900">
            <h3 className="font-display font-semibold text-slate-300 text-sm tracking-wider uppercase flex items-center space-x-1.5">
              <span>4. Deployment Custody</span>
              <ShieldCheck className="h-4 w-4 text-emerald-500 animate-pulse" />
            </h3>

            <div className="rounded-xl border border-emerald-500/10 bg-emerald-950/5 p-4 space-y-3.5">
              <div className="flex items-start space-x-2.5 text-xs text-slate-400">
                <Info className="h-4 w-4 text-emerald-400 shrink-0 mt-0.5" />
                <p className="leading-relaxed text-[11px]">
                  For MVP launchpad simplicity and contract security, your connected wallet is automatically configured as both the contract Owner and the Treasury recipient. Manual wallet adjustments are hidden to prevent key loss or misconfiguration.
                </p>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-1 border-t border-slate-900/60">
